...
import {TgServiceIF, OneToManyReferenceMap, ObjMap} from "@tangential/common";
...
export abstract class UserService implements TgServiceIF<AuthUser> {
  ...
  abstract getRolePermissionsForUser$(user: AuthUser): Observable<ObjMap<AuthPermission>>
