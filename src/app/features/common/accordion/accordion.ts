...
export interface CollapsedChangeEvent {
  item: AccordionItem
  collapsed: boolean
}
...
export class Accordion {
  ...
  @Output() childCollapsedChange: EventEmitter<CollapsedChangeEvent> = new EventEmitter(false)
  ...
  onChildCollapsedChange(event: CollapsedChangeEvent) {
