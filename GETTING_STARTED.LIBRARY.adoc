...
All components require Angular 4+. Some also require firebase. Do take a look at this project's link:./package.json file for the most up to date list of dependencies, or at each package's package.json file for the peer dependencies specific to the package.
